...
class Events extends Component {
  state = {registrationStatus: '', activeId: ''}

  onUpdateRegistrationStatus = registerStatus => {
    this.setState({registrationStatus: registerStatus})
  }
  ...
  render() {
    const {activeId, registrationStatus} = this.state
    return (
          ...
          <ul className="events-list-container">
            {eventsList.map(eachEvent => (
              <EventItem
                ...
                onUpdateActiveId={this.onUpdateActiveId}
